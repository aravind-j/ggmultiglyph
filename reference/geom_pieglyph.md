...
The pieglyph geom is used to plot multivariate data as pie glyphs (Ward
and Lipchak 2000; Fuchs et al. 2013) in a scatterplot.
...
- draw.grid:
  ...
  logical. If `TRUE`, grid levels are plotted along the sectors if all
...
`geom_pieglyph()` understands the following aesthetics (required
