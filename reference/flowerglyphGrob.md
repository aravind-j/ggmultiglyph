...
- z:
  ...
  A numeric vector specifying the values to be plotted as the length of
  the flower glyph petals.
...
- draw.grid:
  ...
  logical. If `TRUE`, grid levels are plotted as nested petals. Default
  is `FALSE`.
